...
char convert_from_ASCII(char *string, unsigned int string_length, unsigned int *stringN);

//function to convert each character in string from a number from 0 to 25 to ASCII
char convert_to_ASCII(char *string, unsigned int string_length, unsigned int *stringN);
...
int main() {
    ...
    convert_from_ASCII(string, string_length, unsigned int *stringN);
    ...
    convert_to_ASCII(string, string_length, unsigned int *stringN);
